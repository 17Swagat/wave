...
#         super().__init__(master=parent,)#fg=DARK_GREY)
#         self.pack(fill='x', pady=(0, 10), ipadx=8)

# class SliderPanel(ComponentFrame):
#     def __init__(self, parent, text, controlProperty_var,
#                  min_value, max_value):
...
#         self.num_label = ctk.CTkLabel(self, text=controlProperty_var.get())
#         self.num_label.grid(column=1, row=0, sticky='e',padx=8)
        
#         ctk.CTkSlider(self, fg_color=SLIDER_BG,
#                       variable=controlProperty_var,
